...
const CTASection = () => {
  ...
  return (
    <>
      <footer className="w-full bg-gray-800 dark:bg-blue-900 py-16 text-center text-white ">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-indigo-200 mb-8 max-w-xl mx-auto">
            Discover how we can help your business scale new heights. Get in
            touch with our team or start a free trial today!
          </p>
      ...
      <FormFill isOpen={formOpen} onClose={() => setFormOpen(false)} />
    </>
  );
};
